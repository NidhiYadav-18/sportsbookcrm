...
@section('space-work')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('manageAgent') }}">Agent list</a></li>
    ...
    <section class="content">
        ...
        <h3 class="card-title">Add Agent</h3>
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="addAgentForm" action="{{ route('postAgent') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Select Master Agent<span class="text-danger">*</span></label>
                                    <select class="form-control select2" style="width: 100%;" name="sub_agent_id"
                                        value="{{ old('sub_agent_id') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first_name"
                                        placeholder="First Name/Alias" name="first_name" value="{{ old('first_name') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tele_id" placeholder="Telegram ID"
                                        name="tele_id" value="{{ old('tele_id') }}">
